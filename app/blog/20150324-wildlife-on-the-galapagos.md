...
geography  :
  - id        : 3658931
    ...
    coord     : [ -90.5, 0 ]
    continent : { code: SA, name: &continent3658931 South America }
    country   : { code: EC, name: &country3658931 Ecuador }
    transport : flight
continents:
  - *continent3658931
countries:
